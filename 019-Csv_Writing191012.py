...
def Information_Collect():
    ...
    return Number, Name, Year_of_Birth, Nationality, Position, Last_Team_before_Bayern, With_·_Now
#信息收集模块

Number, Name, Year_of_Birth, Nationality, Position, Last_Team_before_Bayern, With_·_Now = Information_Collect()
#信息收集执行
