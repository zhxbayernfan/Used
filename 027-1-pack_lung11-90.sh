...
cp ${S1}/cnv/${S2}_rg_cnv_genes${S4}.csv ${S1}/${S3}/${S3}_cnv${S4}.csv
cp ${S1}/cnv/${S2}_rg_cnv_genes${S4}_Curl_gain.csv ${S1}/${S3}/${S3}_Curl_gain.csv
#复制cnv文件以及对应的自动上传文件
...
cp ${S1}/${S2}_indel-lung${S4}-GB18030-baseline.csv ${S1}/${S3}/indel${S3}.csv
cp ${S1}/${S2}_snv-lung${S4}-GB18030-baseline.csv ${S1}/${S3}/snv${S3}.csv
#复制snv/indel文件